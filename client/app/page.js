...
const Page = () => {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden font-sans bg-gradient-to-r from-gray-700 via-gray-900 to-black">
      ...
      <div className="flex-1 flex items-center justify-center text-teal-400 p-8 overflow-hidden">
        <motion.div
          className="max-w-lg"
          initial={{ x: '-100%' }}
          animate={{ x: 0 }}
      ...
      >
        ...
        >
          <h2 className="text-3xl font-semibold text-teal-400 mb-6 text-center">Sign In</h2>
          ...
          {!user ? (
            <>
              ...
              <div className="mt-4">
                <form>
                  <div className="mb-4">
                    <label htmlFor="email" className="block text-teal-400">Email</label>
                    <motion.input
                      type="email"
                      id="email"
                  ...
                  <div className="mb-6">
                    <label htmlFor="password" className="block text-teal-400">Password</label>
                    <motion.input
                      type="password"
                      id="password"
                      className="w-full px-3 py-2 mt-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-teal-400 bg-gray-900 text-white"
